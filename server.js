...
SEND RESET email to corect email
change CONFIRM/RESet link HOST address
2. User management (register, login, pw reset via email) - user notifications = confirm email, ...
3. Static .html serve stop
...
require('./login')(app, auth, genRandom);
///////////////// Configurations
